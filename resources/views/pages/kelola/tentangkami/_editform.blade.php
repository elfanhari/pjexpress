  ...
  <div class="col-md-6 pe-md-3 pe-lg-3">
      <div class="form-group mb-3">
          ...
          <input required type="text" name="name" class="form-control @error('name') is-invalid @enderror"
              value="{{ old('name', $tentangkami->name) }}" placeholder="Masukkan nama perusahaan" id="name" autocomplete="off">
          @error('name')
  ...
  <div class="col-md-6 pe-md-3 pe-lg-3">
      <div class="form-group mb-3">
          ...
          <input required type="text" name="kontak" class="form-control @error('kontak') is-invalid @enderror"
              value="{{ old('kontak', $tentangkami->kontak) }}" placeholder="Masukkan kontak" id="kontak" autocomplete="off">
          @error('kontak')
              <span class="invalid-feedback">{{ $message }}</span>
          @enderror
      </div>
...
<div class="row px-1">
  <div class="col-md-6 pe-md-3 pe-lg-3">
      <div class="form-group mb-3">
          ...
          <textarea required name="alamat" id="" class="form-control" @error('alamat') is-invalid @enderror placeholder="Masukkan alamat">{{ old('alamat', $tentangkami->alamat) }}</textarea>
          @error('alamat')
              <span class="invalid-feedback">{{ $message }}</span>
          @enderror
      </div>
...
<div class="row px-1">
  <div class="col-md-12 pe-md-3 pe-lg-3">
      <div class="form-group mb-3">
          ...
          <textarea required name="tentang_kami" id="" cols="10" rows="6" @error('tentang_kami') is-invalid @enderror class="form-control" placeholder="Masukkan tentang perusahaan">{{ old('tentang_kami', $tentangkami->tentang_kami) }}</textarea>
          @error('tentang_kami')
              <span class="invalid-feedback">{{ $message }}</span>
          @enderror
      </div>
