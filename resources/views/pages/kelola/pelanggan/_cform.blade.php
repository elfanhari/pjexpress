  ...
  <div class="col-md-6 pe-md-3 pe-lg-3">
      <div class="form-group mb-3">
          ...
          <input required type="text" name="name" class="form-control @error('name') is-invalid @enderror"
              value="{{ old('name') }}" placeholder="Masukkan nama pelanggan" id="name" autocomplete="off">
          @error('name')
...
<div class="row px-1">
  <div class="col-md-6 pe-md-3 pe-lg-3">
      <div class="form-group mb-3">
          ...
          <textarea required name="alamat" id="" cols="10" rows="4" class="form-control" placeholder="Masukkan alamat">{{ old('alamat') }}</textarea>
          @error('alamat')
              <span class="invalid-feedback">{{ $message }}</span>
          @enderror
      </div>
