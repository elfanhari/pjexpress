        ...
        <div class="card-body">
          <div class="row px-1 my-2 bg-light rounded">
            <div class="col-6 my-auto py-2 py-md-3">
              <a href="{{ route('pengguna.create') }}" class="btn btn-sm btn-outline-primary rounded-2" data-bs-toggle="tooltip" data-bs-placement="right" title="Tambah Data Pengguna"><span class="bi bi-plus-lg"></span> <span class="d-none d-md-inline d-lg-inline"></span> Pengguna</a>
            </div>
          </div>
          <div class="table-responsive mt-2 mt-md-2 mt-lg-2">
            ...
            @if ($pengguna->isEmpty())
              <div class="mt-3 mb-1">
                Data pengguna tidak ada, silahkan tambah data!
              </div>
            @else
              <table class="table table-sm table-striped table-hover" id="table1">
                <thead>
                  <tr class="bg-secondary text-white">
                    <th scope="col">#</th>
                    <th scope="col">Nama <span class="d-none d-md-inline d-lg-inline">Pengguna</span></th>
                ...
                <tbody class="align-middle">
                  ...
                  <tr>
                    ...
                    <td>{{ $item->username }}</td>
                    <td style="min-width: 200px;" class="text-capitalize">{{ $item->role }}</td>
                    <td class="align-middle">
                      <a href="{{ route('pengguna.show', $item) }}" class="text-success pe-2" >
                      ...
                      <a href="{{ route('pengguna.edit', $item) }}" class="text-primary pe-2" >
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <form action="{{ route('pengguna.destroy', $item) }}" method="POST" class="m-0">
                              @csrf
                              @method('DELETE')
