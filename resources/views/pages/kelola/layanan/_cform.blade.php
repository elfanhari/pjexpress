  ...
  <div class="col-md-6 pe-md-3 pe-lg-3">
      <div class="form-group mb-3">
          ...
          <input required type="text" name="name" class="form-control @error('name') is-invalid @enderror"
              value="{{ old('name') }}" placeholder="Masukkan nama layanan" id="name" autocomplete="off">
          @error('name')
...
<div class="row px-1">
  <div class="col-md-6 pe-md-3 pe-lg-3">
      <div class="form-group mb-3">
          ...
          <textarea required name="deskripsi" id="" cols="10" rows="6" class="form-control" placeholder="Masukkan deskirpsi layanan">{{ old('deskripsi') }}</textarea>
          @error('deskripsi')
              <span class="invalid-feedback">{{ $message }}</span>
          @enderror
      </div>
