...
<div class="pagetitle mb-3">
  <h5 class="fw-bold">Data Layanan</h5>
</div>
        ...
        <div class="card-body">
          <div class="row px-1 my-2 bg-light rounded">
            <div class="col-6 my-auto py-2 py-md-3">
              <a href="{{ route('layanan.create') }}" class="btn btn-sm btn-outline-primary rounded-2" data-bs-toggle="tooltip" data-bs-placement="right" title="Tambah Data Layanan"><span class="bi bi-plus-lg"></span> <span class="d-none d-md-inline d-lg-inline"></span> Layanan</a>
            </div>
          </div>
          <div class="table-responsive mt-2 mt-md-2 mt-lg-2">
            ...
            @if ($layanan->isEmpty())
              <div class="mt-3 mb-1">
                Data layanan tidak ada, silahkan tambah data!
              </div>
            @else
              <table class="table table-sm table-striped table-hover" id="table1">
                <thead>
                  <tr class="bg-secondary text-white">
                    <th scope="col">#</th>
                    <th scope="col">Nama <span class="d-none d-md-inline d-lg-inline">Layanan</span></th>
                ...
                <tbody class="align-middle">
                  ...
                  <tr>
                    ...
                    <td style="min-width: 200px;" class="text-capitalize">{{ Str::limit($item->deskripsi, 150, '...')}}</td>
                    <td class="align-middle">
                      <a href="{{ route('layanan.show', $item) }}" class="text-success pe-2" >
                      ...
                      <a href="{{ route('layanan.edit', $item) }}" class="text-primary pe-2" >
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <form action="{{ route('layanan.destroy', $item) }}" method="POST" class="m-0">
                              @csrf
                              @method('DELETE')
