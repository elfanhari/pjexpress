  ...
  <div class="col-md-6 pe-md-3 pe-lg-3">
      <div class="form-group mb-3">
          ...
          <input required type="text" name="name" class="form-control @error('name') is-invalid @enderror"
              value="{{ old('name', $kendaraan->name) }}" placeholder="Masukkan nama kendaraan" id="name"
              autocomplete="off">
          @error('name')
  ...
  <div class="col-md-6 pe-md-3 pe-lg-3">
      <div class="form-group mb-3">
          ...
          <input required type="text" name="no_polisi" class="form-control @error('no_polisi') is-invalid @enderror"
              value="{{ old('no_polisi', $kendaraan->no_polisi) }}" placeholder="Masukkan nomor polisi" id="no_polisi"
              autocomplete="off">
          @error('no_polisi')
              <span class="invalid-feedback">{{ $message }}</span>
          @enderror
  ...
  <div class="col-md-6 pe-md-3 pe-lg-3">
      <div class="form-group mb-3">
          ...
          <input required type="text" name="no_mesin" class="form-control @error('no_mesin') is-invalid @enderror"
              value="{{ old('no_mesin', $kendaraan->no_mesin) }}" placeholder="Masukkan nomor mesin" id="no_mesin"
              autocomplete="off">
          @error('no_mesin')
              <span class="invalid-feedback">{{ $message }}</span>
          @enderror
  ...
  <div class="col-md-6 pe-md-3 pe-lg-3">
      <div class="form-group mb-3">
          ...
          <input required type="text" name="merk" class="form-control @error('merk') is-invalid @enderror"
              value="{{ old('merk', $kendaraan->merk) }}" placeholder="Masukkan merk" id="merk"
              autocomplete="off">
          @error('merk')
              <span class="invalid-feedback">{{ $message }}</span>
          @enderror
  ...
  <div class="col-md-6 pe-md-3 pe-lg-3">
      <div class="form-group mb-3">
          ...
          <input required type="number" name="tahun" class="form-control @error('tahun') is-invalid @enderror"
              value="{{ old('tahun', $kendaraan->tahun) }}" placeholder="Masukkan tahun" id="tahun"
              autocomplete="off">
          @error('tahun')
              <span class="invalid-feedback">{{ $message }}</span>
          @enderror
  ...
  <div class="col-md-6 pe-md-3 pe-lg-3">
      <div class="form-group mb-3">
          ...
          <input required type="text" name="warna" class="form-control @error('warna') is-invalid @enderror"
              value="{{ old('warna', $kendaraan->warna) }}" placeholder="Masukkan warna" id="warna"
              autocomplete="off">
          @error('warna')
              <span class="invalid-feedback">{{ $message }}</span>
          @enderror
    ...
    <div class="form-group mb-3">
      ...
      <select name="supir_id" class="form-select @error('supir_id') is-invalid @enderror" id="supir_id" required>
          ...
          @foreach ($supirs as $item)
            <option value="{{ $item->id }}" {{ $item->id == old('supir_id', $kendaraan->supir_id) ? 'selected' : '' }}>{{ $item->user->name }} - {{ $item->telepon }}</option>
          @endforeach
      </select>
      @error('supir_id')
        <span class="invalid-feedback">{{ $message }}</span>
