...
<div class="pagetitle mb-3">
  <h5 class="fw-bold">Data Kendaraan</h5>
</div>
        ...
        <div class="card-body">
          <div class="row px-1 my-2 bg-light rounded">
            <div class="col-6 my-auto py-2 py-md-3">
              <a href="{{ route('kendaraan.create') }}" class="btn btn-sm btn-outline-primary rounded-2" data-bs-toggle="tooltip" data-bs-placement="right" title="Tambah Data Kendaraan"><span class="bi bi-plus-lg"></span> <span class="d-none d-md-inline d-lg-inline"></span> Kendaraan</a>
            </div>
          </div>
          <div class="table-responsive mt-2 mt-md-2 mt-lg-2">
            ...
            @if ($kendaraan->isEmpty())
              <div class="mt-3 mb-1">
                Data kendaraan tidak ada, silahkan tambah data!
              </div>
            @else
              <table class="table table-sm table-striped table-hover" id="table1">
                ...
                <tbody class="align-middle">
                  ...
                  <tr>
                    ...
                    <td>{{ $item->tahun }}</td>
                    <td>{{ $item->warna }}</td>
                    <td style="min-width: 200px;">{{ $item->supir->user->name }}</td>
                    <td class="align-middle">
                      {{-- <a href="{{ route('kendaraan.show', $item) }}" class="text-success pe-2" >
                      ...
                      <a href="{{ route('kendaraan.edit', $item) }}" class="text-primary pe-2" >
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            No Polisi: <b>{{ $item->no_polisi }}</b>
                          </div>
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                            <form action="{{ route('kendaraan.destroy', $item) }}" method="POST" class="m-0">
                              @csrf
                              @method('DELETE')
